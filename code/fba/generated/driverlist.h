// This file was generated by C:\temp\fba\src\scripts\gamelist.pl (perl 5.008007)
...
DRV		BurnDrvSeganinj;
#if defined FBA_DEBUG
DRV		BurnDrvTeddybb;			// Sega [NOT WORKING]
#endif
DRV		BurnDrvTumblep;
DRV		BurnDrvWboy;
DRV		BurnDrv99lstwar;
...
DRV		BurnDrvarkbloc2;
#if defined FBA_DEBUG
DRV		BurnDrvBlockgal;		// no comment [NOT WORKING]
#endif
DRV		BurnDrvBloodwar;
#if defined FBA_DEBUG
...
DRV		BurnDrvGanryu;
#if defined FBA_DEBUG
DRV		BurnDrvGardia;			// no comment [NOT WORKING]
#endif
DRV		BurnDrvGaroubl;
DRV		BurnDrvGaroup;
DRV		BurnDrvGarou;
...
DRV		BurnDrvTws96;
#if defined FBA_DEBUG
DRV		BurnDrvTeddybbo;		// no comment [NOT WORKING]
...
DRV		BurnDrvWboyu;
#if defined FBA_DEBUG
DRV		BurnDrvWboyo;			// no comment [NOT WORKING]
DRV		BurnDrvWboy2;			// no comment [NOT WORKING]
#endif
DRV		BurnDrvWboy2u;
#if defined FBA_DEBUG
DRV		BurnDrvWboy3;			// no comment [NOT WORKING]
DRV		BurnDrvWboy4;			// no comment [NOT WORKING]
#endif
DRV		BurnDrvWbdeluxe;
#if defined FBA_DEBUG
...
#if defined FBA_DEBUG
	&BurnDrvBlockgal,			// Block Gal (MC-8123B, 317-0029) [no comment, NOT WORKING]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvGardia,				// Gardia (317-0006) [no comment, NOT WORKING]
#endif
...
#if defined FBA_DEBUG
	&BurnDrvTeddybbo,			// TeddyBoy Blues (315-5115, Old Ver.) [no comment, NOT WORKING]
...
#if defined FBA_DEBUG
	&BurnDrvWboyo,				// Wonder Boy (set 1, 315-5135) [no comment, NOT WORKING]
	&BurnDrvWboy2,				// Wonder Boy (set 2, 315-5178) [no comment, NOT WORKING]
#endif
	&BurnDrvWboy2u,				// Wonder Boy (set 2, not encrypted)
#if defined FBA_DEBUG
	&BurnDrvWboy3,				// Wonder Boy (set 3, 315-5135) [no comment, NOT WORKING]
	&BurnDrvWboy4,				// Wonder Boy (set 4, 315-5162) [no comment, NOT WORKING]
#endif
