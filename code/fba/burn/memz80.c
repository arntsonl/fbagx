...
unsigned int cpu_readmem16(unsigned int address)
{
  switch((address >> 13) & 7)
  {
    ...
    default: /* V-bus bank */
      //return z80_read_banked_memory(zbank | (address & 0x7fff)); // zbank not declared
	  return z80_read_banked_memory((address & 0x7fff));
  }
}
...
void cpu_writemem16(unsigned int address, unsigned int data)
{
  switch((address >> 13) & 7)
  {
    ...
    default: /* V-bus bank */
      ...
      z80_write_banked_memory((address & 0x7fff), data);
	  return;
  }
}
