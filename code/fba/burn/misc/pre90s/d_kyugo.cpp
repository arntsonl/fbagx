...
static int KyugoInit()
{
	...
	AY8910Init(0, 1500000, nBurnSoundRate, &KyugoDip0Read, &KyugoDip1Read, NULL, NULL);
...
static int KyugoFrame()
{
	...
	nCyclesTotal[0] = (18432000 / 4) / 60;
	nCyclesTotal[1] = (18432000 / 4) / 60;
