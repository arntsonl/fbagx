...
static int AquajackInit()
{
	...
	BurnYM2610Init(16000000 / 2, YM2610ADPCMAROM, &YM2610ADPCMASize, YM2610ADPCMBROM, &YM2610ADPCMBSize, &TaitoZFMIRQHandler, TaitoZSynchroniseStream, TaitoZGetTime);
...
static int BsharkInit()
{
	...
	BurnYM2610Init(16000000 / 2, YM2610ADPCMAROM, &YM2610ADPCMASize, YM2610ADPCMBROM, &YM2610ADPCMBSize, NULL, TaitoZ68KSynchroniseStream, TaitoZ68KGetTime);
