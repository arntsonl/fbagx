...
static int DrvInit()
{
	...
	ZetMapArea(0xc000, 0xcfff, 0, Ram  + 0x03000);
	ZetMapArea(0xc000, 0xcfff, 1, Ram  + 0x03000);
	ZetMapArea(0xc000, 0xcfff, 2, Ram  + 0x03000);
	...
	BurnYM2203Init(2, 1500000, NULL, gunsmokeSynchroniseStream, gunsmokeGetTime);
...
static int DrvFrame()
{
	...
	for (int i = 0; i < nInterleave; i++) {
		...
		if ((i % 4) == 3) {
			...
			BurnTimerEndFrame(nCyclesTotal[nCurrentCPU] / 4);
