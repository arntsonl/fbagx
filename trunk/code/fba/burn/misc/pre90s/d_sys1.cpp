...
static void mc8123_decrypt_rom(int banknum, int numbanks)
{
	UINT8 *decrypted1 = System1Fetch1;
//	UINT8 *decrypted2 = numbanks > 1 ? auto_malloc(0x4000 * numbanks) : decrypted1 + 0x8000;
	UINT8 *rom = System1Rom1;
	UINT8 *key = System1MC8123Key;
	int A, bank;
...
unsigned char __fastcall NoboranbZ80PortRead1(unsigned short a)
{
	a &= 0xff;
...
static int System1Init(int nZ80Rom1Num, int nZ80Rom1Size, int nZ80Rom2Num, int nZ80Rom2Size, int nTileRomNum, int nTileRomSize, int nSpriteRomNum, int nSpriteRomSize, bool bReset)
{
	...
	memcpy(Temp, System1Rom1, 0x8000);
	...
	SN76489AInit(0, 2000000);
	SN76489AInit(1, 4000000);
...
static int BrainInit()
{
	...
	ZetOpen(0);
	ZetSetOutHandler(BrainZ80PortWrite1);
	ZetClose();
...
static int NoboranbInit()
{
	...
	ZetMemCallback(0xc000, 0xc3ff, 1 );
	ZetMemCallback(0xc800, 0xcbff, 1 );
	ZetSetWriteHandler(NoboranbZ80Write1);
	ZetSetInHandler(NoboranbZ80PortRead1);
	ZetSetOutHandler(NoboranbZ80PortWrite1);
	ZetClose();
...
struct BurnDriverD BurnDrvBlockgal = {
	"blockgal", NULL, NULL, "1987",
	"Block Gal (MC-8123B, 317-0029)\0", NULL, "Sega / Vic Tokai", "System 1",
	NULL, NULL, NULL, NULL,
	BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_MISC_PRE90S,
	NULL, BlockgalRomInfo, BlockgalRomName, MyheroInputInfo, NULL,
...
struct BurnDriverD BurnDrvGardia = {
...
struct BurnDriverD BurnDrvTeddybb = {
...
struct BurnDriverD BurnDrvTeddybbo = {
...
struct BurnDriverD BurnDrvWboyo = {
...
struct BurnDriverD BurnDrvWboy2 = {
...
struct BurnDriverD BurnDrvWboy3 = {
...
struct BurnDriverD BurnDrvWboy4 = {
