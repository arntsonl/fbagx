...
extern void SN76489Init(int Num, int Clock);
extern void SN76489AInit(int Num, int Clock);
extern void SN76494Init(int Num, int Clock);
extern void SN76496Init(int Num, int Clock);
